define( [
    ...
    'app',
    'specs/fixtures/all',
    'specs/fixtures/notfound',
    'specs/fixtures/searchHl'
], function (sinon, Solrita, app, all, notFound, searchHl) {
  describe("SolrPaginatedCollection Unit Spec", function () {
    describe("With Stub", function () {
      describe("With all records found", function () {
        ...
        it("should has infoSolr", function () {
          expect(this.paginatedCollection.getInfoSolr()).toBeDefined();
        });
        ...
        it("should has default facet.field array", function () {
          facetFields = _.bind(
          this.paginatedCollection.queryParams['facet.field'], this.paginatedCollection);
      ...
      describe("With Search and Highlighting", function () {
        ...
        it("should has a record with a name value", function () {
          expect(this.paginatedCollection.models[0].get("name").value.value).toEqual("Solr, the Enterprise Search Server");
        });
